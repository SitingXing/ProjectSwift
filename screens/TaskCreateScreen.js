            ...
            <ScrollView style={styles.inputArea}>
                ...
                <View style={styles.input}>
                    ...
                    <View style={styles.selectorContainer}>
                        ...
                        >
                            <Text style={[styles.inputStyle, { fontFamily: "Poppins_400Regular" },]}>{stage.stageName}</Text>
                            <Icon
                                name="chevron-down"
                                type="entypo"
                                size={18}
                        ...
                        <View style={styles.stageDates}>
                            {Object.keys(stage).length !== 0 ? (
                                <Text style={[styles.stageDateP, { fontFamily: "Poppins_400Regular" }]}>
                                    {(new Date(stage.startDate)).toLocaleDateString()}
                                </Text>
                            ) : (
                                <Text style={[styles.stageDateP, { fontFamily: "Poppins_400Regular" }]}>Start</Text>
                            )}
                            <Text style={[styles.stageDateTo, { fontFamily: "Poppins_400Regular" }]}>to</Text>
                            {Object.keys(stage).length !== 0 ? (
                                <Text style={[styles.stageDateP, { fontFamily: "Poppins_400Regular" }]}>
                                    {(new Date(stage.endDate)).toLocaleDateString()}
                                </Text>
                            ) : (
                                <Text style={[styles.stageDateP, { fontFamily: "Poppins_400Regular" }]}>End</Text>
                            )}
                        </View>
                    </View>
                </View>
